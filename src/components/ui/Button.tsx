...
export const buttonVariants = tv({
  ...
  variants: {
    ...
    size: {
      medium: {
        root: 'text-label-sm h-10 gap-3 rounded-xl px-3.5',
        icon: '-mx-1',
      },
      small: {
        root: 'text-label-sm h-9 gap-3 rounded-xl px-3',
        icon: '-mx-1',
      },
      xsmall: {
        root: 'text-label-sm h-8 gap-2.5 rounded-xl px-2.5',
        icon: '-mx-1',
      },
      xxsmall: {
        root: 'text-label-sm h-7 gap-2.5 rounded-xl px-2',
        icon: '-mx-1',
      },
    },
  },
